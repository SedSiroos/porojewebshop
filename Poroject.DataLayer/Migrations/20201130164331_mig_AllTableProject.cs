...
{
    public partial class mig_AllTableProject : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermissonRoles", x => x.PR_ID);
                    table.ForeignKey(
                        name: "FK_PermissonRoles_Permission_PermissionId",
                        column: x => x.PermissionId,
                        principalTable: "Permission",
                        principalColumn: "PermissionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PermissonRoles_roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissonRoles_PermissionId",
                table: "PermissonRoles",
                column: "PermissionId");

            migrationBuilder.CreateIndex(
                name: "IX_PermissonRoles_RoleId",
                table: "PermissonRoles",
                column: "RoleId");
